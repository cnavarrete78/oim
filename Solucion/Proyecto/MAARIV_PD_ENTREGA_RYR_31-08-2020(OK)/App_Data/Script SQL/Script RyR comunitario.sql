...
BEGIN
	SET NOCOUNT ON
	select	ID_PLAN_ACCION_TRASLADO, [ID_COMUNIDAD],
	...
	ID_MUNICIPIO_SALIDA, D.DAN_CCOD_DEPARTAMENTO AS ID_DEPARTAMENTO_SALIDA ,	ID_MUNICIPIO_LLEGADA ,DL.DAN_CCOD_DEPARTAMENTO AS ID_DEPARTAMENTO_LLEGADA, 	ID_ENTORNO_SALIDA ,	ID_ENTORNO_LLEGADA ,	CORREGIMIENTO_SALIDA ,	CORREGIMIENTO_LLEGADA  
...
BEGIN		
	...
	BEGIN		
		DECLARE @FECHA DATETIME
		SET @FECHA = GETDATE()
		INSERT INTO [RYR_COMUNITARIO].TB_PLAN_ACCION_TRASLADO_BALANCE_TRASLADO_EVIDENCIA  (ID_BALANCE_TRASLADO, ID_TIPO_EVIDENCIA, URL_ARCHIVO,EXTENSION, ID_USUARIO, FECHA_SISTEMA, ACTIVO) 
																				   VALUES (@ID_BALANCE_TRASLADO, @ID_TIPO_EVIDENCIA, @URL_ARCHIVO,@EXTENSION, @ID_USUARIO, @FECHA,@ACTIVO)
...
BEGIN
	SET NOCOUNT ON
	select ID, ID_BALANCE_TRASLADO, E.ID_TIPO_EVIDENCIA,TE.NOMBRE AS TIPO_EVIDENCIA, URL_ARCHIVO, EXTENSION 

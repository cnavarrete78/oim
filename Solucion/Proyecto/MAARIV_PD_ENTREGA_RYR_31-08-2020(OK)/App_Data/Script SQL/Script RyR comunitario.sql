...
AS
BEGIN		
 SELECT ID_PERSONA, HOGAR, PERSONA, DOCUMENTO, FECHA_NACIMIENTO, SEXO, PARENTESCO, TELEFONO
 DEPARTAMENTO_RESIDENCIA,MUNICIPIO_RESIDENCIA, BARRIO, DIRECCION_RESIDENCIA, ID_PERSONA_RUV  
 FROM [RYR_COMUNITARIO].[V_RYR_PERSONAS_CARACTERIZADAS_PARA_TRASLADAR] WHERE ID_RYR_COMUNIDAD = 28--@ID_COMUNIDAD
END
go	
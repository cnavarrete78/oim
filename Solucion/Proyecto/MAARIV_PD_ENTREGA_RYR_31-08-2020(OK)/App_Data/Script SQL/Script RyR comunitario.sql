...
BEGIN		
 ...
 SSV.[IDENTIFICACION],[SALUD],[ATENCION_PSICOSOCIAL],[EDUCACION],[ALIMENTACION],[VIVIENDA],[REUNIFICACION_FAMILIAR],[GENERACION_INGRESOS],[FECHA_MEDICION]--DATOS DEbbbbbb
 ...
 LEFT OUTER JOIN  [dbo].[V_PERSONAS_MAARIV] AS P ON HA.ID_PERSONA = P.ID_PERSONA 
 LEFT OUTER JOIN  [dbo].[RYR_HOGAR_SSV] as SSV ON  HA.ID_SOLICITUD_SGV_HOGAR =SSV.[ID_SOLICITUD_SGV_HOGAR]
 WHERE C.ID_RYR_COMUNIDAD = 28--@ID_COMUNIDAD
END
go	

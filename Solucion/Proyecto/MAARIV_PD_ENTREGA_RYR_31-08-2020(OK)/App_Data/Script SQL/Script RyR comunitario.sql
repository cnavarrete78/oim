...
AS
BEGIN		
	IF NOT EXISTS( SELECT TOP 1 1 FROM  RYR_COMUNITARIO.TB_PLAN_ACCION_TRASLADO_BALANCE_TRASLADO WHERE ID_PLAN_ACCION_TRASLADO = @ID_PLAN_ACCION_TRASLADO)
	BEGIN	
	...
	ELSE
	BEGIN
		UPDATE [RYR_COMUNITARIO].TB_PLAN_ACCION_TRASLADO_BALANCE_TRASLADO  SET ACTIVIDAD = @ACTIVIDAD,RESPONSABLE=@RESPONSABLE,CUMPLIDA= @CUMPLIDA,OBSERVACIONES= OBSERVACIONES  WHERE ID_PLAN_ACCION_TRASLADO =@ID_PLAN_ACCION_TRASLADO
	END
END
go

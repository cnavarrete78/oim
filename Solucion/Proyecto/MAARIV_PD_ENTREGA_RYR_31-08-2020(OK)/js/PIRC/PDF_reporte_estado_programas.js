...
var getDatosFormateados = async function (dataPDF) {
    ...
    fila = [
        {
            text: 'REPORTE PROGRAMA ATENCIÓN ACOMPAÑAMIENTO',
            style: 'titlePIRC0'
        }
    ];
...
function resizedataURL(datas, wantedWidth, wantedHeight){
    return new Promise(async function(resolve,reject){
        ...
        {        
            ...
            var canvas = document.createElement('printChartId');
...
function doPDFPIRC(idSujeto)
{
    $.ajax({
        type: "GET",
        url: "/modulos/Colectiva/Planes_RC_Integrado.aspx/ObtenerDatosPDF?idSujeto=" + 1,
...
async function generatePDFPIRC(dat)
{
    ...
    try
    {
                                    ...
                                    table: {
                                        ...
                                        body: [
                                            ...
                                            [
                                                {},
                                                {
                                                    text: 'ESTADO DE LOS PROGRAMAS SEGÚN CRITERIOS DE NOMBRE DEL ACOMPAÑAMIENTO Y/O TERRITORIAL',
                                                    colSpan: 4,
                                                    style: 'headerPIRC2'
                                                }, {}, {}, {}
                                            ],
        ...
        pdfMake.createPdf(docDefinition).download('Reporte_estado_programa.pdf');
    } catch(err)
    {
